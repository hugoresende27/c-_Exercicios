...
At the end of 10 years you would like to have $10000 in the account. How much would you need to deposit today toi make that happen? 
You can use the following formula which is known as the percent value formula, to find out:
		F
P =   -----
...
Write a program that has a function named presentValue that performs this calculation. The function should accept the future value,
 annual interest rate, and number of years in the arguments. It should return the present value, which is the amount that you need to deposit 
 today.
